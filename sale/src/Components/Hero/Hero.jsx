...
<div className="border-slate-300 shadow-md border rounded-xl w-full h-full center">
      ...
      <div className="flex sm:flex-row flex-col justify-between items-center gap-5 shadow-black shadow-lg m-3 p-3 rounded-xl w-11/12 heroimg">
      ...
      <img src={currentImage2} alt="Product image" className="shadow-xl rounded-xl w-full h-[200px] image" />
